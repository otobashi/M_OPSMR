          ...
          SELECT KWL.FACTORY_REGION1
            ...
            FROM (
                    SELECT ROWNUMBER() OVER(ORDER BY T.YYYYMM_ORIG_ID ) AS MONTH_rn
                     ...
                     WHERE T.YYYYMM_ORIG_ID BETWEEN '201001' AND '201606'
...
/*
                               WHERE L.FACTORY_REGION1 = 'LGEKR(Mobile)'
                                 AND L.GBU_CODE = 'MST'
                                 AND L.USED_FLAG ='Y'*/
                               WHERE L.USED_FLAG = 'Y'
...
/*                               WHERE LV.FACTORY_REGION = 'LGEKR(Mobile)'
                                 AND LV.GBU_CODE = 'MST'
...
/*   AND A.FACTORY_REGION1 = 'LGEKR(Mobile)'
   AND A.GBU_CODE = 'MST'*/
       LEFT OUTER JOIN
       (
            ...
            FROM (
                    SELECT F.TARGET_CODE,
                     ...
                     WHERE F.TARGET_CODE ='PD_002'
                       ...
                       AND F.GBU_CODE = 'CVT'
/*                       AND F.FACTORY_REGION1 = 'LGEKR(Mobile)'
                       AND F.GBU_CODE = 'MST'*/
